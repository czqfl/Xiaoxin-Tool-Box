const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/styles-DzMhGQFo.css","assets/theme-D29g89ck.css","assets/sticky-main-C18yn1_m.js","assets/settings-DikDMGDC.js","assets/pin-path.const-Bic-ch4A.js","assets/index-DoxHwSNj.js","assets/index-BpvutWXK.js","assets/client-BBaZcKOw.js","assets/index-CnVeNpEK.js","assets/App-C9G1PDPf.js","assets/webviewWindow-Cr3D_jCO.js","assets/index--ziH6xz5.js","assets/App-lscFcHdH.css","assets/base-_qXebFqI.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
async function bootstrap() {
  ...
  const isSticky = label.startsWith("note_") || label === "sticky-history" || // 全屏透明粒子层窗口（label 与 tauri.conf.json / glow-particles 查找一致）
  label === "particles" || label === "sticky-imageviewer" || label === "sticky-settings";
  if (isSticky) {
    document.documentElement.dataset.window = "sticky";
    await __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([0]) : void 0);
    await __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([1]) : void 0);
    syncToolboxTheme();
    void listen("config://changed", () => {
      syncToolboxTheme();
      void __vitePreload(() => import("./settings-DikDMGDC.js").then((n) => n.x), true ? [] : void 0).then((m) => m.refreshThemeFromToolbox());
    });
    const { mountStickyByLabel } = await __vitePreload(async () => {
      const { mountStickyByLabel: mountStickyByLabel2 } = await import("./sticky-main-C18yn1_m.js");
      return { mountStickyByLabel: mountStickyByLabel2 };
    }, true ? __vite__mapDeps([2,3,4]) : void 0);
    mountStickyByLabel();
    return;
  }
  const panelLabels = [
  ...
  const [{ default: React }, { default: ReactDOM }, { default: App }] = await Promise.all([
    __vitePreload(() => import("./index-DoxHwSNj.js").then((n) => n.i), true ? __vite__mapDeps([5,6]) : void 0),
    __vitePreload(() => import("./client-BBaZcKOw.js").then((n) => n.c), true ? __vite__mapDeps([7,6,8]) : void 0),
    __vitePreload(() => import("./App-C9G1PDPf.js"), true ? __vite__mapDeps([9,6,5,10,11,8,4,12]) : void 0)
  ]);
...
export {
  ...
  getAllWindows as b,
  currentMonitor as c,
  LogicalPosition as d,
  emit as e,
  emitTo as f,
  getCurrentWindow as g,
  Position as h,
  invoke as i,
  listen as l,
  once as o
